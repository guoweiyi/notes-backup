...
- 大于 x 的第一个元素的前一个元素（如果有）便是小于等于 x 的第一个元素
-  大于等于 x的第一个元素的前一个元素（如果有）便是小于 x的第一个元素
...
标签: [C++](https://io.zouht.com/tag/C/), [STL](https://io.zouht.com/tag/STL/), [语法](https://io.zouht.com/tag/语法/)